...
namespace DevilDaggersCore.Game
{
	public static class GameInfo
	{
		...
		public static readonly Enemy V1Squid1 = new(GameVersion.V1, "Squid I", "4E3000", 10, 1, 2, 0x0, V1Purged, 1, null, 3);
		public static readonly Enemy V1Squid2 = new(GameVersion.V1, "Squid II", "804E00", 20, 2, 3, 0x1, V1Sacrificed, 2, null, 39);
		public static readonly Enemy V1Centipede = new(GameVersion.V1, "Centipede", "837E75", 75, 25, 25, 0x2, V1Eviscerated, 25, null, 114);
		public static readonly Enemy V1Gigapede = new(GameVersion.V1, "Gigapede", "7B5157", 250, 50, 50, 0x5, V1Eviscerated, 50, null, 264);
		public static readonly Enemy V1Leviathan = new(GameVersion.V1, "Leviathan", "FF0000", 600, 6, 6, 0x4, V1Devastated, 600, null, 397);
		public static readonly Enemy V1Spider1 = new(GameVersion.V1, "Spider I", "097A00", 25, 1, 1, 0x3, V1Infested, 3, null, 39);

		public static readonly Enemy V1Skull1 = new(GameVersion.V1, "Skull I", "352710", 1, 0, 0, null, V1Swarmed, 0.25f, null, null, V1Squid1, V1Squid2);
		public static readonly Enemy V1Skull2 = new(GameVersion.V1, "Skull II", "433114", 5, 1, 1, null, V1Impaled, 1, null, null, V1Squid1);
		public static readonly Enemy V1Skull3 = new(GameVersion.V1, "Skull III", "6E5021", 10, 1, 1, null, V1Dismembered, 1, null, null, V1Squid2);

		public static readonly Enemy V1TransmutedSkull2 = new(GameVersion.V1, "Transmuted Skull II", "721A13", 10, 1, 1, null, V1Impaled, 1, null, null, V1Leviathan);
		public static readonly Enemy V1TransmutedSkull3 = new(GameVersion.V1, "Transmuted Skull III", "982319", 20, 1, 1, null, V1Dismembered, 2, null, null, V1Leviathan);
		public static readonly Enemy V1TransmutedSkull4 = new(GameVersion.V1, "Transmuted Skull IV", "BE2C20", 100, 0, 0, null, V1Annihilated, 10, null, null, V1Leviathan);

		public static readonly Enemy V1SpiderEgg1 = new(GameVersion.V1, "Spider Egg I", "99A100", 3, 0, 0, null, V1Infested, 3, null, null, V1Spider1);
		public static readonly Enemy V1Spiderling = new(GameVersion.V1, "Spiderling", "DCCB00", 3, 0, 0, null, V1Stricken, 1, null, null, V1SpiderEgg1);
		...
		public static readonly Enemy V2Squid1 = new(GameVersion.V2, "Squid I", "4E3000", 10, 1, 2, 0x0, V2Purged, 1, 1, 3);
		public static readonly Enemy V2Squid2 = new(GameVersion.V2, "Squid II", "804E00", 20, 2, 3, 0x1, V2Desecrated, 2, 1, 39);
		public static readonly Enemy V2Squid3 = new(GameVersion.V2, "Squid III", "AF6B00", 90, 3, 3, 0x6, V2Sacrificed, 3, 9, 244);
		public static readonly Enemy V2Centipede = new(GameVersion.V2, "Centipede", "837E75", 75, 25, 25, 0x2, V2Eviscerated, 25, 25, 114);
		public static readonly Enemy V2Gigapede = new(GameVersion.V2, "Gigapede", "7B5157", 250, 50, 50, 0x5, V2Annihilated, 50, 50, 259);
		public static readonly Enemy V2Leviathan = new(GameVersion.V2, "Leviathan", "FF0000", 1500, 6, 6, 0x4, V2Devastated, 1500, 1500, 350);
		public static readonly Enemy V2Spider1 = new(GameVersion.V2, "Spider I", "097A00", 25, 1, 1, 0x3, V2Infested, 3, 3, 39);
		public static readonly Enemy V2Spider2 = new(GameVersion.V2, "Spider II", "13FF00", 200, 1, 1, 0x8, V2Envenomated, 20, 20, 274);

		public static readonly Enemy V2Skull1 = new(GameVersion.V2, "Skull I", "352710", 1, 0, 0, null, V2Swarmed, 0.25f, 0.25f, null, V2Squid1, V2Squid2, V2Squid3);
		public static readonly Enemy V2Skull2 = new(GameVersion.V2, "Skull II", "433114", 5, 1, 1, null, V2Impaled, 1, 1, null, V2Squid1);
		public static readonly Enemy V2Skull3 = new(GameVersion.V2, "Skull III", "6E5021", 10, 1, 1, null, V2Gored, 1, 1, null, V2Squid2);
		public static readonly Enemy V2Skull4 = new(GameVersion.V2, "Skull IV", "976E2E", 100, 0, 0, null, V2Opened, 10, 10, null, V2Squid3);

		public static readonly Enemy V2TransmutedSkull1 = new(GameVersion.V2, "Transmuted Skull I", "4C110C", 10, 0, 0, null, V2Swarmed, 0.25f, 10, null, V2Leviathan);
		public static readonly Enemy V2TransmutedSkull2 = new(GameVersion.V2, "Transmuted Skull II", "721A13", 20, 1, 1, null, V2Impaled, 2, 2, null, V2Leviathan);
		public static readonly Enemy V2TransmutedSkull3 = new(GameVersion.V2, "Transmuted Skull III", "982319", 100, 1, 1, null, V2Gored, 10, 10, null, V2Leviathan);
		public static readonly Enemy V2TransmutedSkull4 = new(GameVersion.V2, "Transmuted Skull IV", "BE2C20", 300, 0, 0, null, V2Opened, 30, 30, null, V2Leviathan);

		public static readonly Enemy V2SpiderEgg1 = new(GameVersion.V2, "Spider Egg I", "99A100", 3, 0, 0, null, V2Infested, 3, 3, null, V2Spider1);
		public static readonly Enemy V2SpiderEgg2 = new(GameVersion.V2, "Spider Egg II", "657A00", 3, 0, 0, null, V2Envenomated, 3, 3, null, V2Spider2);
		public static readonly Enemy V2Spiderling = new(GameVersion.V2, "Spiderling", "DCCB00", 3, 0, 0, null, V2Stricken, 1, 1, null, V2SpiderEgg1, V2SpiderEgg2);

		public static readonly Enemy V2Andras = new(GameVersion.V2, "Andras", "666666", 25, 1, 1, 0x7, null, null, null, null);
		...
		public static readonly Enemy V3Squid1 = new(GameVersion.V3, "Squid I", "4E3000", 10, 1, 2, 0x0, V3Purged, 1, 1, 3);
		public static readonly Enemy V3Squid2 = new(GameVersion.V3, "Squid II", "804E00", 20, 2, 3, 0x1, V3Desecrated, 2, 1, 39);
		public static readonly Enemy V3Squid3 = new(GameVersion.V3, "Squid III", "AF6B00", 90, 3, 3, 0x6, V3Sacrificed, 3, 9, 244);
		public static readonly Enemy V3Centipede = new(GameVersion.V3, "Centipede", "837E75", 75, 25, 25, 0x2, V3Eviscerated, 25, 25, 114);
		public static readonly Enemy V3Gigapede = new(GameVersion.V3, "Gigapede", "478B41", 250, 50, 50, 0x5, V3Annihilated, 50, 50, 259);
		public static readonly Enemy V3Ghostpede = new(GameVersion.V3, "Ghostpede", "C8A2C8", 500, 10, 10, 0x9, V3Intoxicated, null, null, 442);
		public static readonly Enemy V3Leviathan = new(GameVersion.V3, "Leviathan", "FF0000", 1500, 6, 6, 0x4, V3Incarnated, 1500, 1500, 350);
		public static readonly Enemy V3Thorn = new(GameVersion.V3, "Thorn", "771D00", 120, 0, 0, 0x7, V3Barbed, 12, 12, 447);
		public static readonly Enemy V3Spider1 = new(GameVersion.V3, "Spider I", "097A00", 25, 1, 1, 0x3, V3Intoxicated, 3, 3, 39);
		public static readonly Enemy V3Spider2 = new(GameVersion.V3, "Spider II", "13FF00", 200, 1, 1, 0x8, V3Envenomated, 20, 20, 274);

		public static readonly Enemy V3TheOrb = new(GameVersion.V3, "The Orb", "FF3131", 2400, 0, 0, null, V3Discarnated, 2400, 2400, null, V3Leviathan);

		public static readonly Enemy V3Skull1 = new(GameVersion.V3, "Skull I", "352710", 1, 0, 0, null, V3Swarmed, 0.25f, 0.25f, null, V3Squid1, V3Squid2, V3Squid3);
		public static readonly Enemy V3Skull2 = new(GameVersion.V3, "Skull II", "433114", 5, 1, 1, null, V3Impaled, 1, 1, null, V3Squid1);
		public static readonly Enemy V3Skull3 = new(GameVersion.V3, "Skull III", "6E5021", 10, 1, 1, null, V3Gored, 1, 1, null, V3Squid2);
		public static readonly Enemy V3Skull4 = new(GameVersion.V3, "Skull IV", "976E2E", 100, 0, 0, null, V3Opened, 10, 10, null, V3Squid3);

		public static readonly Enemy V3TransmutedSkull1 = new(GameVersion.V3, "Transmuted Skull I", "4C110C", 10, 0, 0, null, V3Swarmed, 0.25f, 10, null, V3Leviathan, V3TheOrb);
		public static readonly Enemy V3TransmutedSkull2 = new(GameVersion.V3, "Transmuted Skull II", "721A13", 20, 1, 1, null, V3Impaled, 2, 2, null, V3Leviathan, V3TheOrb);
		public static readonly Enemy V3TransmutedSkull3 = new(GameVersion.V3, "Transmuted Skull III", "982319", 100, 1, 1, null, V3Gored, 10, 10, null, V3Leviathan, V3TheOrb);
		public static readonly Enemy V3TransmutedSkull4 = new(GameVersion.V3, "Transmuted Skull IV", "BE2C20", 300, 0, 0, null, V3Opened, 30, 30, null, V3Leviathan, V3TheOrb);

		public static readonly Enemy V3SpiderEgg1 = new(GameVersion.V3, "Spider Egg I", "99A100", 3, 0, 0, null, V3Intoxicated, 3, 3, null, V3Spider1);
		public static readonly Enemy V3SpiderEgg2 = new(GameVersion.V3, "Spider Egg II", "657A00", 3, 0, 0, null, V3Envenomated, 3, 3, null, V3Spider2);
		public static readonly Enemy V3Spiderling = new(GameVersion.V3, "Spiderling", "DCCB00", 3, 0, 0, null, V3Infested, 1, 1, null, V3SpiderEgg1, V3SpiderEgg2);
		...
		public static readonly Enemy V31Squid1 = new(GameVersion.V31, "Squid I", "4E3000", 10, 1, 2, 0x0, V31Purged, 1, 1, 3);
		public static readonly Enemy V31Squid2 = new(GameVersion.V31, "Squid II", "804E00", 20, 2, 3, 0x1, V31Desecrated, 2, 1, 39);
		public static readonly Enemy V31Squid3 = new(GameVersion.V31, "Squid III", "AF6B00", 90, 3, 3, 0x6, V31Sacrificed, 3, 9, 244);
		public static readonly Enemy V31Centipede = new(GameVersion.V31, "Centipede", "837E75", 75, 25, 25, 0x2, V31Eviscerated, 25, 25, 114);
		public static readonly Enemy V31Gigapede = new(GameVersion.V31, "Gigapede", "478B41", 250, 50, 50, 0x5, V31Annihilated, 50, 50, 259);
		public static readonly Enemy V31Ghostpede = new(GameVersion.V31, "Ghostpede", "C8A2C8", 500, 10, 10, 0x9, V31Haunted, null, null, 442);
		public static readonly Enemy V31Leviathan = new(GameVersion.V31, "Leviathan", "FF0000", 1500, 6, 6, 0x4, V31Incarnated, 1500, 1500, 350);
		public static readonly Enemy V31Thorn = new(GameVersion.V31, "Thorn", "771D00", 120, 0, 0, 0x7, V31Entangled, 12, 12, 447);
		public static readonly Enemy V31Spider1 = new(GameVersion.V31, "Spider I", "097A00", 25, 1, 1, 0x3, V31Intoxicated, 3, 3, 39);
		public static readonly Enemy V31Spider2 = new(GameVersion.V31, "Spider II", "13FF00", 200, 1, 1, 0x8, V31Envenomated, 20, 20, 274);

		public static readonly Enemy V31TheOrb = new(GameVersion.V31, "The Orb", "FF3131", 2400, 0, 0, null, V31Discarnated, 2400, 2400, null, V31Leviathan);

		public static readonly Enemy V31Skull1 = new(GameVersion.V31, "Skull I", "352710", 1, 0, 0, null, V31Swarmed, 0.25f, 0.25f, null, V31Squid1, V31Squid2, V31Squid3);
		public static readonly Enemy V31Skull2 = new(GameVersion.V31, "Skull II", "433114", 5, 1, 1, null, V31Impaled, 1, 1, null, V31Squid1);
		public static readonly Enemy V31Skull3 = new(GameVersion.V31, "Skull III", "6E5021", 10, 1, 1, null, V31Gored, 1, 1, null, V31Squid2);
		public static readonly Enemy V31Skull4 = new(GameVersion.V31, "Skull IV", "976E2E", 100, 0, 0, null, V31Opened, 10, 10, null, V31Squid3);

		public static readonly Enemy V31TransmutedSkull1 = new(GameVersion.V31, "Transmuted Skull I", "4C110C", 10, 0, 0, null, V31Swarmed, 0.25f, 10, null, V31Leviathan, V31TheOrb);
		public static readonly Enemy V31TransmutedSkull2 = new(GameVersion.V31, "Transmuted Skull II", "721A13", 20, 1, 1, null, V31Impaled, 2, 2, null, V31Leviathan, V31TheOrb);
		public static readonly Enemy V31TransmutedSkull3 = new(GameVersion.V31, "Transmuted Skull III", "982319", 100, 1, 1, null, V31Gored, 10, 10, null, V31Leviathan, V31TheOrb);
		public static readonly Enemy V31TransmutedSkull4 = new(GameVersion.V31, "Transmuted Skull IV", "BE2C20", 300, 0, 0, null, V31Opened, 30, 30, null, V31Leviathan, V31TheOrb);

		public static readonly Enemy V31SpiderEgg1 = new(GameVersion.V31, "Spider Egg I", "99A100", 3, 0, 0, null, V31Intoxicated, 3, 3, null, V31Spider1);
		public static readonly Enemy V31SpiderEgg2 = new(GameVersion.V31, "Spider Egg II", "657A00", 3, 0, 0, null, V31Envenomated, 3, 3, null, V31Spider2);
		public static readonly Enemy V31Spiderling = new(GameVersion.V31, "Spiderling", "DCCB00", 3, 0, 0, null, V31Infested, 1, 1, null, V31SpiderEgg1, V31SpiderEgg2);
		...
		private static readonly Dictionary<Enemy, string[]> _enemyInfo = new()
		{
			...
			{ V31Centipede, new[] { "Emerges approximately 3 seconds after its spawn, starts flying idly for a while, then starts chasing the player", "Burrows after 15 seconds of being emerged, or if the player gets too close to its head" } },
			...
			{ V32Centipede, new[] { "Emerges approximately 3 seconds after its spawn, starts flying idly for a while, then starts chasing the player", "Burrows after 15 seconds of being emerged, or if the player gets too close to its head" } },
		...
		private static readonly List<Death> _v1Deaths = _entities.OfType<Death>().Where(e => e.GameVersion == GameVersion.V1).ToList();
		private static readonly List<Enemy> _v1Enemies = _entities.OfType<Enemy>().Where(e => e.GameVersion == GameVersion.V1).ToList();
		private static readonly List<Upgrade> _v1Upgrades = _entities.OfType<Upgrade>().Where(e => e.GameVersion == GameVersion.V1).ToList();

		private static readonly List<Dagger> _v2Daggers = _entities.OfType<Dagger>().Where(e => e.GameVersion == GameVersion.V2).ToList();
		private static readonly List<Death> _v2Deaths = _entities.OfType<Death>().Where(e => e.GameVersion == GameVersion.V2).ToList();
		private static readonly List<Enemy> _v2Enemies = _entities.OfType<Enemy>().Where(e => e.GameVersion == GameVersion.V2).ToList();
		private static readonly List<Upgrade> _v2Upgrades = _entities.OfType<Upgrade>().Where(e => e.GameVersion == GameVersion.V2).ToList();

		private static readonly List<Dagger> _v3Daggers = _entities.OfType<Dagger>().Where(e => e.GameVersion == GameVersion.V3).ToList();
		private static readonly List<Death> _v3Deaths = _entities.OfType<Death>().Where(e => e.GameVersion == GameVersion.V3).ToList();
		private static readonly List<Enemy> _v3Enemies = _entities.OfType<Enemy>().Where(e => e.GameVersion == GameVersion.V3).ToList();
		private static readonly List<Upgrade> _v3Upgrades = _entities.OfType<Upgrade>().Where(e => e.GameVersion == GameVersion.V3).ToList();

		private static readonly List<Dagger> _v31Daggers = _entities.OfType<Dagger>().Where(e => e.GameVersion == GameVersion.V31).ToList();
		private static readonly List<Death> _v31Deaths = _entities.OfType<Death>().Where(e => e.GameVersion == GameVersion.V31).ToList();
		...
		public static Death? GetDeathByType(GameVersion gameVersion, int deathType)
