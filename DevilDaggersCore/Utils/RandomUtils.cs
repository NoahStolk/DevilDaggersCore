...
namespace DevilDaggersCore.Utils
{
	public static class RandomUtils
	{
		...
		public static int RandomInt(int maxValue) => _random.Next(maxValue);
...
#pragma warning disable S2234 // Parameters should be passed in the correct order
		public static int RandomInt(int minValue, int maxValue) => minValue > maxValue ? _random.Next(maxValue, minValue) : _random.Next(minValue, maxValue);
#pragma warning restore S2234 // Parameters should be passed in the correct order
		...
		public static float RandomFloat(float maxValue) => (float)_random.NextDouble() * maxValue;
		...
		/// <param name="maxValue">The maximum value.</param>
		/// <returns>The random <see cref="float"/>.</returns>
		public static float RandomFloat(float minValue, float maxValue) => (float)_random.NextDouble() * (maxValue - minValue) + minValue;
		...
		public static double RandomDouble(double maxValue) => _random.NextDouble() * maxValue;
		...
		/// <param name="maxValue">The maximum value.</param>
		/// <returns>The random <see cref="double"/>.</returns>
		public static double RandomDouble(double minValue, double maxValue) => _random.NextDouble() * (maxValue - minValue) + minValue;
		...
		public static T Choose<T>(params T[] options) => options[_random.Next(options.Length)];
